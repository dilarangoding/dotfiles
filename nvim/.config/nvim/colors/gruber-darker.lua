...
hi("TelescopePromptBorder", { fg = c.bg1, bg = c.bg1 })
hi("TelescopePromptTitle", { fg = c.black, bg = c.yellow, bold = true })
hi("TelescopePromptPrefix", { fg = c.yellow, bg = c.bg1 })
hi("TelescopePromptCounter", { fg = c.brown, bg = c.bg1 })
...
hi("TelescopeSelectionCaret", { fg = c.yellow, bg = c.bg1 })
